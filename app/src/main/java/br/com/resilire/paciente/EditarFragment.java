...
public class EditarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_editar_paciente, container, false);
        ...
        Button btnEditar = (Button) v.findViewById(R.id.button_SalvarEditarPaciente);
        ...
        Button btnExcluir = (Button) v.findViewById(R.id.button_ExcluirEditarPaciente);
